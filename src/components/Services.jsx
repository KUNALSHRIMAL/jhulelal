...
const allServices = [
  {
    ...
    description:
      "Handcrafted using age-old recipes, our kulfis come in a variety of classic and innovative flavors, rich in texture and taste.",
  },
  {
    title: "Delicious Ice Creams",
    description:
      "From fruity scoops to creamy delights, our ice creams are made with premium milk and real ingredients — no shortcuts, just pure joy.",
  },
  {
    title: "Customized Orders",
    description:
      "We cater to parties, events, and bulk orders for restaurants, parlours, and retailers. Your satisfaction is our priority.",
  },
  // {
