  ...
  return (
    ...
    >
      ...
      >
        ...
        Join Us on This <br /> <span className="text-white">Sweet Journey</span>
        </h2>
        <p className="text-lg md:text-xl text-purple-100 mb-6 font-medium tracking-wide">
          Whether you’re an ice cream lover, a kulfi enthusiast, or a business looking for a reliable supplier — we are here to make your moments sweeter.
        </p>
